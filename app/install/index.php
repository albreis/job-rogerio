...
$checkFilePermission = $Requirements->checkFilePermission();
$checkServerRequirement = $Requirements->checkServerRequirement(['mysqli','intl','session']);
                            ...
                            <div id="wizard" class="aiia-wizard">
                                ...
                                <div class="aiia-wizard-step <?php echo $activeClass ?>">
                                    ...
                                    <div class="row action_btns">
                                        ...
                                        <?php if($checkFilePermission == 1 && $checkServerRequirement == 1){?>
    ...
    <div class="container fText">
        <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
            <div class="row">
                ...
                <div class="col-sm-6  text-right"><a target="_blank" href="https://bdtask.com/blog"><span class="glyphicon glyphicon-user"></span> Installation Support</a></div>
            </div>
        </div>
    </div>
</footer>
