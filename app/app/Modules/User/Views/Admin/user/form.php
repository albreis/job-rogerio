    ...
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="text-right">
                <div class="actions">
                     <a class="btn btn-success w-md m-b-5 pull-right" href="<?php echo base_url("backend/user/user-list") ?>"><i class="fa fa-list" aria-hidden="true"></i> <?php echo display('user_list') ?></a>
                </div>
            </div>
        </div>
    </div>
