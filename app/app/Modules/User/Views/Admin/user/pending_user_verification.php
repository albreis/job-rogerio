                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 card-body">
                	...
                	<div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <?php if ($user->verified == 3 || $user->verified == 13 || $user->verified == 12 || $user->verified == 14) { echo "<span class='text-success'>Processing</span> &nbsp;&nbsp;<i class='fas fa-spinner fa-pulse text-success' aria-hidden='true'></i>"; } ?>
                            </h5>
                        </div>
                    </div>
