...
class CmsController extends BaseController
{
        ...
        if($this->request->getMethod() == 'post'){
            ...
            if($this->validation->withRequest($this->request)->run())
            {
                ...
                $jsondata = array(
                    ...
                    'body_background_color'     => $this->request->getPost('body_background_color', FILTER_UNSAFE_RAW),
                    'body_font_color'     => $this->request->getPost('body_font_color', FILTER_UNSAFE_RAW),
                    'menu_bg_color'     => $this->request->getPost('menu_bg_color', FILTER_UNSAFE_RAW),
                    'menu_font_color'   => $this->request->getPost('menu_font_color', FILTER_UNSAFE_RAW),
                    'footer_bg_color'   => $this->request->getPost('footer_bg_color', FILTER_UNSAFE_RAW),
                    'footer_font_color' => $this->request->getPost('footer_font_color', FILTER_UNSAFE_RAW),
                    'btn_bg_color'      => $this->request->getPost('btn_bg_color', FILTER_UNSAFE_RAW),
                    'btn_font_color'    => $this->request->getPost('btn_font_color', FILTER_UNSAFE_RAW),
                    'top_footer_horizontal_border_color'    => $this->request->getPost('top_footer_horizontal_border_color', FILTER_UNSAFE_RAW),
                    'footer_menu_border_color'    => $this->request->getPost('footer_menu_border_color', FILTER_UNSAFE_RAW),
                    'bottom_footer_background_color'    => $this->request->getPost('bottom_footer_background_color', FILTER_UNSAFE_RAW),
                    'bottom_footer_font_color'    => $this->request->getPost('bottom_footer_font_color', FILTER_UNSAFE_RAW),
                    'theme_color'       => $this->request->getPost('theme_color', FILTER_UNSAFE_RAW),
                    'newslatter_bg'     => $this->request->getPost('newslatter_bg', FILTER_UNSAFE_RAW),
                    'newslatter_font'   => $this->request->getPost('newslatter_font', FILTER_UNSAFE_RAW),
                    'form_background_color'   => $this->request->getPost('form_background_color', FILTER_UNSAFE_RAW),
                    'form_border_color'   => $this->request->getPost('form_border_color', FILTER_UNSAFE_RAW),
                    'form_label_color'   => $this->request->getPost('form_label_color', FILTER_UNSAFE_RAW),
                    'form_input_field_background_color'   => $this->request->getPost('form_input_field_background_color', FILTER_UNSAFE_RAW),
                    'input_field_border_color'   => $this->request->getPost('input_field_border_color', FILTER_UNSAFE_RAW),
                    'input_field_color'   => $this->request->getPost('input_field_color', FILTER_UNSAFE_RAW),
                );
    ...
    { 
        ...
        if($this->request->getMethod() == 'post'){
            ...
            if ($this->validate($rules, $rules)) 
            {
                ...
                if(!empty($this->request->getPost('password',FILTER_UNSAFE_RAW))){
                    $newpassword = md5($this->request->getPost('password',FILTER_UNSAFE_RAW));
                ...
                $data['admin'] = (object)$adminLevelData = array(
                    ...
                    'firstname'   => $this->request->getPost('firstname', FILTER_UNSAFE_RAW),
                    'lastname'    => $this->request->getPost('lastname', FILTER_UNSAFE_RAW),
                    'email'       => $this->request->getPost('email', FILTER_UNSAFE_RAW),
                    'password'    => $newpassword,
                    'about'       => $this->request->getPost('about',FILTER_UNSAFE_RAW),
                    'image'       => (!empty($image)?$image:$this->request->getPost('old_image', FILTER_UNSAFE_RAW)),
                    'last_login'  => null,
                    'last_logout' => null,
                    'ip_address'  => null,
    ...
    public function add_page_content($article_id = null)
    {
        ...
        if($this->request->getPost('pdflink') == "1") {

            $this->validation->setRule('article_pdf', 'PDF File', "ext_in[article_pdf,pdf]"); 
            $this->validation->setRule('pageHeight','Page Height', 'required|numeric|trim');
        } 
        ...
        if($this->request->getMethod() == 'post'){
            if($this->validation->withRequest($this->request)->run())
            {
                ...
                $data['article']   = (object)$userdata = array(
                    ...
                    'article_id'        => $this->request->getPost('article_id', FILTER_UNSAFE_RAW),
                    'headline_en'       => $this->request->getPost('headline_en', FILTER_UNSAFE_RAW),
                    'headline_fr'       => $this->request->getPost('headline_fr', FILTER_UNSAFE_RAW), 
                    'pdflink'           => $pdflink, 
                    'article_pdf'       => $pdfpath, 
                    'pageHeight'        => $this->request->getPost('pageHeight', FILTER_UNSAFE_RAW), 
                    'article_image'     => $image,  
                    ...
                    'video'             => $this->request->getPost('video', FILTER_UNSAFE_RAW),
                    'cat_id'            => $this->request->getPost('cat_id', FILTER_UNSAFE_RAW),
                    'page_content'      => 1,
                    'position_serial'   => $this->request->getPost('position_serial', FILTER_UNSAFE_RAW),
    ...
    public function add_faq($article_id = null)
    {
        ...
        if($this->request->getMethod() == 'post'){
            ...
            $data['article']   = (object)$userdata = array(
                'headline_en'   => $this->request->getPost('headline_en', FILTER_UNSAFE_RAW),
                'headline_fr'   => $this->request->getPost('headline_fr', FILTER_UNSAFE_RAW),
                'article1_en'   => $this->request->getPost('article1_en', FILTER_UNSAFE_RAW),
                'article1_fr'   => $this->request->getPost('article1_fr', FILTER_UNSAFE_RAW),
    ...
    */
    ...
    public function add_news($article_id = null)
    {
        ...
        $slug = url_title(strip_tags($this->request->getPost('headline_en')??""), '-', FILTER_UNSAFE_RAW);
    ...
    public function add_category($cat_id = null)
    {
        ...
        if($this->request->getMethod() == 'post'){
             ...
             $data['category']   = (object)$userdata = array(
                ...
                'slug'          => $slug = url_title(strip_tags($this->request->getPost('cat_name_en')??""), '-', FILTER_UNSAFE_RAW),
                'cat_name_en'   => $this->request->getPost('cat_name_en', FILTER_UNSAFE_RAW),
                'cat_name_fr'   => $this->request->getPost('cat_name_fr', FILTER_UNSAFE_RAW),
                'parent_id'     => $this->request->getPost('parent_id', FILTER_UNSAFE_RAW),
                'cat_title1_en' => $this->request->getPost('cat_title1_en', FILTER_UNSAFE_RAW),
                'cat_title1_fr' => $this->request->getPost('cat_title1_fr', FILTER_UNSAFE_RAW),
                'cat_image'     => $image_path,
                'cat_title2_en' => $this->request->getPost('cat_title2_en', FILTER_UNSAFE_RAW),
                'cat_title2_fr' => $this->request->getPost('cat_title2_fr', FILTER_UNSAFE_RAW),
                'menu'          => $this->request->getPost('menu', FILTER_UNSAFE_RAW),
                'position_serial'=> $this->request->getPost('position_serial', FILTER_UNSAFE_RAW),
                'status'        => $this->request->getPost('status', FILTER_UNSAFE_RAW)
            );
    ...
    public function add_slider($id = null)
    {
        ...
        if($this->request->getMethod() == 'post'){
            ...
            $data['slider']   = (object)$sliderdata = array(
                ...
                'slider_h1_en'  => $this->request->getPost('slider_h1_en', FILTER_UNSAFE_RAW),
                'slider_h1_fr'  => $this->request->getPost('slider_h1_fr', FILTER_UNSAFE_RAW), 
                'slider_h2_en'  => $this->request->getPost('slider_h2_en', FILTER_UNSAFE_RAW), 
                'slider_h2_fr'  => $this->request->getPost('slider_h2_fr', FILTER_UNSAFE_RAW),
                'slider_h3_en'  => $this->request->getPost('slider_h3_en', FILTER_UNSAFE_RAW),
                'slider_h3_fr'  => $this->request->getPost('slider_h3_fr', FILTER_UNSAFE_RAW),
                'slider_img'    => $image_path,
                'custom_url'    => $this->request->getPost('custom_url', FILTER_UNSAFE_RAW),
                'status'        => $this->request->getPost('status', FILTER_UNSAFE_RAW)
            );
    ...
    */
    ...
    public function add_social_link($id = null)
    {
        ...
        $data['social_link']   = (object)$userdata = array(
            ...
            'link'  => $this->request->getPost('link', FILTER_UNSAFE_RAW), 
            'icon'  => $this->request->getPost('icon', FILTER_UNSAFE_RAW), 
            'status'=> $this->request->getPost('status', FILTER_UNSAFE_RAW)
        );
    ...
    public function add_advertisement($id = null)
    {
        ...
        if($this->request->getMethod() == 'post'){
            ...
            $data['advertisement']  = (object)$advertisementdata = array(
                ...
                'name'              => $this->request->getPost('name', FILTER_UNSAFE_RAW),
                'page'              => $this->request->getPost('page', FILTER_UNSAFE_RAW), 
                'image'             => @$image_path,
                'script'            => $this->request->getPost('script'),
                'url'               => $this->request->getPost('url', FILTER_UNSAFE_RAW),
                'serial_position'   => $this->request->getPost('serial_position', FILTER_UNSAFE_RAW),
                'status'            => $this->request->getPost('status', FILTER_UNSAFE_RAW)
            );
    ...
    */
    public function weblanguage_list($id = 1)
    {
        ...
        $data['language'] = (object)$userdata = array(
            ...
            'name'  => $this->request->getPost('name', FILTER_UNSAFE_RAW),
            'flag'  => $this->request->getPost('flag', FILTER_UNSAFE_RAW)
        );
