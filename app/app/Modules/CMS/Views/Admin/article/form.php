            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-right">
                        <div class="actions">
                            <a href="<?php echo base_url('backend/cms/page-content-list'); ?>" class="btn btn-success w-md m-b-5 pull-right"><i class="fa fa-list" aria-hidden="true"></i> <?php echo display('page_content_list') ?></a>
                        </div>
                    </div>
                </div>
            </div>
                   ...
                   <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input name="article_pdf" class="form-control" placeholder="<?php echo display('upload_pdf') ?>" type="file" id="article_pdf">
                             ...
                             <?php if (@$article->article_pdf != NULL) { 
                                echo @$article->article_pdf; } ?>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="pageHeight" class="col-sm-2 col-form-label font-weight-600"><?php echo display('page_height');?></label>
                        <div class="col-sm-10">
                            <input name="pageHeight" value="<?php echo strip_tags($article->pageHeight??'') ?>" class="form-control" placeholder="<?php echo display('page_height'); ?> Example: 800" type="text" id="pageHeight">
                        </div>
                    </div>
                    <div class="form-group row">
