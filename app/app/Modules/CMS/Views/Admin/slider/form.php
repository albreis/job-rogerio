        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-right">
                        <div class="actions">
                           <a href="<?php echo base_url('backend/cms/slider-list'); ?>" class="btn btn-success w-md m-b-5 pull-right"><i class="fa fa-list" aria-hidden="true"></i> <?php echo display('slider_list') ?></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <?php echo form_hidden('id', @$slider->id) ?> 
                    ...
                    <div class="form-group row">
                        <label for="slider_h3_fr" class="col-sm-4 col-form-label font-weight-600"><?php echo display('button_text')." ".esc($web_language->name) ?></label>
                        <div class="col-sm-8">
