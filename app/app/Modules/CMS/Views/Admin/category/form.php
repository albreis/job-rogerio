            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-right">
                        <div class="actions">
                            <a href="<?php echo base_url('backend/cms/category-list'); ?>" class="btn btn-success w-md m-b-5 pull-right"><i class="fa fa-list" aria-hidden="true"></i> <?php echo display('category_list') ?></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="border_preview">
                        ...
                        <div class="form-group row">
                            <label for="cat_title2_en" class="col-sm-4 font-weight-600"><?php echo display('cat_title_en') ?> 2</label>
                            <div class="col-sm-8">
                                <input name="cat_title2_en" value="<?php echo esc($category->cat_title2_en) ?>" class="form-control" placeholder="<?php echo display('cat_title_en') ?> 2" type="text" id="cat_title2_en">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="cat_title2_fr" class="col-sm-4 font-weight-600"><?php echo display('cat_title_fr');?> 2</label>
                            <div class="col-sm-8">
                                <input name="cat_title2_fr" value="<?php echo esc($category->cat_title2_fr) ?>" class="form-control" placeholder="<?php echo display('cat_title_fr'); ?> 2" type="text" id="cat_title2_fr">
                            </div>
                        </div>
                        <div class="form-group row">
