...
class Api extends BaseController
{
    ...
    public function symbols()
    {
        ...
        $symbol   = $this->request->getGet('symbol', FILTER_UNSAFE_RAW);
        $data = array(
    ...
    public function history()
    {
      ...
      $market_symbol = $this->request->getGet('symbol', FILTER_UNSAFE_RAW);
      $from          = date("Y-m-d", $this->request->getGet('from', FILTER_UNSAFE_RAW));
      $to            = date("Y-m-d", $this->request->getGet('to', FILTER_UNSAFE_RAW));
