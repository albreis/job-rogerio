    ...
    <div class="col-md-6 col-lg-3">
        <div class="d-flex flex-column p-3 mb-3 bg-violet shadow-sm rounded">
            ...
            <div class="d-flex align-items-center text-size-3">
                ...
                <div class="text-monospace text-white">
                    <span class="text-size-3 p-3"><?php echo number_format(@$maxBuyCurrency->totalBuyAmount?$maxBuyCurrency->totalBuyAmount:"0",4)." ".@$maxBuyCurrency->currency_symbol; ?></span>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-6 col-lg-3">
        <div class="d-flex flex-column p-3 mb-3 bg-color3 shadow-sm rounded">
            ...
            <div class="d-flex align-items-center text-size-3">
                ...
                <div class="text-monospace text-white">
                    <span class="text-size-3 p-3" ><?php echo number_format(@$maxSellCurrency->totalSellAmount?$maxSellCurrency->totalSellAmount:'0',4)." ".@$maxSellCurrency->currency_symbol; ?></span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="col-sm-12 col-md-9">
                        <h6 class="header-pretitle text-muted fs-13 font-weight-bold text-uppercase mb-1"><?php echo display('deposit');?>, <?php echo display('withdraw');?></h6>
                    </div>
