                ...
                <table  id="example" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php } else if (esc($value->status)==5) { ?>
                            ...
                            <td class="text-center"> <?php echo display('send_gasfee');?></td>
                            ...
                            <td class="text-center"> <i title="<?php echo display('canceled');?>" class="fas fa-times text-danger"></i></td>
                             <?php } else if (($value->status == 0 || $value->status == 6) && $value->expire_date < date('Y-m-d H:i:s')){ ?>
