<div class="header-slider header-slider-preloader" id="header-slider">
    ...
    foreach ($slider as $key => $value) {
        ...
        $slide_h1 =  isset($lang) && $lang =="english"?$value->slider_h1_en:$value->slider_h1_fr;
        $slide_h2 =  isset($lang) && $lang =="english"?$value->slider_h2_en:$value->slider_h2_fr;
        $slide_h3 =  isset($lang) && $lang =="english"?$value->slider_h3_en:$value->slider_h3_fr;
    ...
    <div class="container">
           <div class="row">
               <div class="col-md-10 offset-md-1 text-center about-text pt-3 pb-2"> 
                <?php $headline     =   isset($lang) && $lang =="english"?$welcome->headline_en:$welcome->headline_fr;
                      $article1     =   isset($lang) && $lang =="english"?$welcome->article1_en:$welcome->article1_fr;?>
