            ...
            <div class="col-md-6 col-lg-5">
                <div class="bio-info">
                    <dl class="dl-horizontal">
                        ...
                        <dd class="<?php if($user_info->verified == '1' || $user_info->verified == '6' || $user_info->verified == '13') echo 'd-flex'; ?>"><?php echo esc($user_info->email); ?><br> 

                        <?php echo (esc($user_info->verified) == 0 || esc($user_info->verified) == 2|| esc($user_info->verified) == 3 || esc($user_info->verified) == 4|| esc($user_info->verified) == 5|| esc($user_info->verified) == 7 || esc($user_info->verified) == 14 || esc($user_info->verified) == 15 || esc($user_info->verified) == 10)?"<a href='".base_url('email-verify')."' class='btn btn-success mx-4'>".display('email-verify')."</a>":((esc($user_info->verified) == 1 || esc($user_info->verified) == 6 || esc($user_info->verified) == 8 || esc($user_info->verified) == 9 || esc($user_info->verified) == 10 || esc($user_info->verified) == 12 || esc($user_info->verified) == 13)?" <span class='verify-color'><i class='fa fa-check-circle'></i></span>":" <a href='".base_url('email-verify')."' class='btn btn-success mx-4'>".display('email-verify')."</a>"); ?>


                        </dd>
                        <dt><?php echo display('phone') ?> :</dt>
                        <dd class="<?php if($user_info->verified == '5' || $user_info->verified == '7' || $user_info->verified == '9') echo 'd-flex'; ?>"><?php if(empty($user_info->phone)) {echo "<span class='verify-cancel'>Update your phone number</span>";} else { echo esc($user_info->phone); ?> 
                         <?php echo (esc($user_info->verified) == 0 ||  esc($user_info->verified) == 2|| esc($user_info->verified) == 3 || esc($user_info->verified) == 4|| esc($user_info->verified) == 6|| esc($user_info->verified) == 8 || esc($user_info->verified) == 13 || esc($user_info->verified) == 11)?"<a href='".base_url('phone-verify')."' class='btn btn-success ml-4'>".display('phone-verify')."</a>":((esc($user_info->verified) == 1 || esc($user_info->verified) == 5 || esc($user_info->verified) == 7 || esc($user_info->verified) == 9 || esc($user_info->verified) == 10 || esc($user_info->verified) == 12 || esc($user_info->verified) == 14 || esc($user_info->verified) == 15)?" <span class='verify-color'><i class='fa fa-check-circle'></i></span>":" <a href='".base_url('email-verify')."' class='btn btn-success ml-4'>".display('phone-verify')."</a>"); }?>
                        </dd>
