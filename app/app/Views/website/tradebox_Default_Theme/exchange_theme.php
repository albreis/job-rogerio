...
<html lang="en">
   ...
   <body class="dark-theme">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                         ...
                         foreach ($languages as $key => $language) { ?>
                            <li class="<?php echo isset($lang) && $lang == $key?'active':''; ?>"><a href="#" class="language-exchange <?php echo $key;?>" data-id="<?php echo $key ;?>"><?php echo ucwords(esc($language));?></a></li>
    ...
    <script src="<?php echo BASEPATH.'exchange/assets/js/exchange.js?v=1.3' ?>"></script>
