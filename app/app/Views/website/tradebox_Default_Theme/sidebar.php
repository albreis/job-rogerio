...
<?php if ($recentnews) { ?>
    ...
    <div class="widget">
        ...
        foreach ($recentnews as $news_key => $news_value) {
            ...
            $news_headline      =   isset($lang) && $lang =="english"?$news_value->headline_en:$news_value->headline_fr;
            $news_article1      =   isset($lang) && $lang =="english"?$news_value->article1_en:$news_value->article1_fr;
            ...
            $cat_name = isset($lang) && $lang =="english"?$cat_slug->cat_name_fr:$cat_slug->cat_name_en;
        ?>
    ...
    <div class="widget">
        ...
        <ul class="widget_category">
            ...
            foreach ($newscat as $key => $value) {
                $newscatname_list  = isset($lang) && $lang =="english"?$value->cat_name_en:$value->cat_name_fr;
